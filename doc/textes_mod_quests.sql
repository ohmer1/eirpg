...
--- modify it under the terms of the GNU General Affero Public License
...
--
-- Textes de quete aventure et royaume.
--
...
(NULL, 'Qa', 'trouver la sorcière qui a pu mettre au monde une immonde horreur se présentant sous le nom de Womby.'),
(NULL, 'Qa', 'trouver les statuettes de Gloubkir le maléfique.'),
(NULL, 'Qa', 'effectuer les 23 Travaux Titanesques.'),
(NULL, 'Qa', 'trouver un ciseau qui arrivera à bout de la fourrure de bouboule_de_poil.'),
(NULL, 'Qa', 'retrouver Homer perdu et terrifié dans une forêt comptant à peine 34 arbres et 12 lapins.'),
(NULL, 'Qa', 'attraper le lapin-garou qui terrorise la population de la ville de Dertiofré.'),
(NULL, 'Qa', 'retrouver les statuettes de Glafeubleurk enroulées dans du jambon et trempées dans du jus de chaussette de Stalker.'),
(NULL, 'Qa', 'piller la ville rebelle de Frytagraume.'),
